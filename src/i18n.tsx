...
const translations = {
  ...
  'wizard.sadadFinancing': { en: 'SADAD Financing', ar: 'تمويل سداد' },
  'wizard.completeSteps': { en: 'Complete the steps below to submit your financing request', ar: 'أكمل الخطوات أدناه لتقديم طلب التمويل' },
  'wizard.submitting': { en: 'Submitting your request', ar: 'جارٍ تقديم طلبك' },
  'wizard.requestCreated': { en: 'Request Created!', ar: 'تم إنشاء الطلب!' },
  'wizard.requestCreatedDesc': { en: 'Your financing request has been successfully created.', ar: 'تم إنشاء طلب التمويل بنجاح.' },
  'wizard.applicationRef': { en: 'Application Reference', ar: 'مرجع الطلب' },
  'wizard.whatsNext': { en: "What's Next?", ar: 'ما التالي؟' },
  'wizard.nextStep1': { en: 'Our team reviews your application', ar: 'فريقنا يراجع طلبك' },
  'wizard.nextStep2': { en: 'Receive your financing offer', ar: 'تستلم عرض التمويل' },
  'wizard.nextStep3': { en: 'Accept and get funded', ar: 'اقبل واحصل على التمويل' },
  'wizard.goToDashboard': { en: 'Go to Application Dashboard', ar: 'الذهاب إلى لوحة التحكم' },
  ...
  'wizard.selectBillerTitle': { en: 'Select Biller', ar: 'اختر المفوتر' },
  'wizard.showingBillersIn': { en: 'Showing billers in', ar: 'عرض المفوترين في' },
  'wizard.searchBiller': { en: 'Search biller name or ID...', ar: 'ابحث عن اسم المفوتر أو الرقم...' },
  'wizard.manualBillerEntry': { en: 'Manual Biller Entry', ar: 'إدخال مفوتر يدوياً' },
  'wizard.billerName': { en: 'Biller Name', ar: 'اسم المفوتر' },
  'wizard.enterBillerName': { en: 'Enter biller name', ar: 'أدخل اسم المفوتر' },
  'wizard.billerAccountNo': { en: 'Biller ID / Account Number', ar: 'رقم المفوتر / رقم الحساب' },
  'wizard.enterAccountNo': { en: 'Enter account number', ar: 'أدخل رقم الحساب' },
  'wizard.billNumber': { en: 'Bill Number', ar: 'رقم الفاتورة' },
  'wizard.enterBillNo': { en: 'Enter bill number', ar: 'أدخل رقم الفاتورة' },
  'wizard.amount': { en: 'Amount', ar: 'المبلغ' },
  'wizard.dueDate': { en: 'Due Date', ar: 'تاريخ الاستحقاق' },
  'wizard.addBill': { en: 'Add Bill', ar: 'إضافة فاتورة' },
