...
function LoanCard({ loan, delay, query }: { loan: Loan; delay: number; query: string }) {
  ...
  return (
    ...
    >
      ...
      {/* Product */}
      <p style={{ fontSize: 14, color: '#475569', marginBottom: 4 }}>{loan.product}</p>

      {/* Subtitle */}
      <p style={{ fontSize: 13, color: '#94A3B8', marginBottom: 20 }}>{loan.subtitle}</p>
      ...
      <p style={{ fontSize: 22, fontWeight: 700, color: '#0F172A', marginBottom: 20 }}>
        SAR {loan.amount.toLocaleString()}
      </p>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                <LoansIcon size={24} color="#0F172A" />
                <h2 style={{ fontSize: 22, fontWeight: 700, color: '#0F172A' }}>My Loans</h2>
              </div>
              <motion.button
              ...
              {FILTERS.map(f => {
                ...
                return (
                  <button key={f.key} onClick={() => setActiveFilter(f.key)} style={{
                    ...
                    background: isActive ? '#2563EB' : '#fff', color: isActive ? '#fff' : '#475569',
                    border: isActive ? 'none' : '1px solid #E2E8F0', cursor: 'pointer',
            ...
            <AnimatePresence mode="popLayout">
              {filtered.length === 0 ? (
                ...
                >
                  <p style={{ fontSize: 15, fontWeight: 600, color: '#64748B', marginBottom: 4 }}>No loans found</p>
